...
def Suma_Octetos(octetos, P1,P2,P3,P4):
...
def division_redes():
    ...
    while lhjdfis==1:
        ...
        def Primera_Subred(Sumatoria):
            print("1", end='       ')
            Suma_Octetos(0,                            P1,P2,P3,P4)
            Suma_Octetos((1),                           P1,P2,P3,P4)
            Ultima_dirección=Sumatoria-2
            Suma_Octetos((Ultima_dirección),            P1,P2,P3,P4)
            Suma_Octetos((Ultima_dirección+1),          P1,P2,P3,P4)
       
       
       
        def Total_Suma(Sumatoria):
            Suma_Octetos((Sumatoria),                        P1,P2,P3,P4)
            Suma_Octetos((Sumatoria+1),                      P1,P2,P3,P4)
            Ultima_dirección=suma-3
            Suma_Octetos((Sumatoria+1+Ultima_dirección),      P1,P2,P3,P4)
            Suma_Octetos((Sumatoria+Ultima_dirección+2),      P1,P2,P3,P4)
        print('')
